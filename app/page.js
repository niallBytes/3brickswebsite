...
const TESTIMONIALS = [
  ...
  initial: 'S',
  stars: 5,
  text: 'Honestly, I can’t complain about anything. From start to finish, everything went smoothly. The work quality is top-notch, and they were easy to work with. Recommend!!',
},
{
  name: 'Neena Ravi',
  location: '',
...
{
  name: 'Paresh Thorat',
  location: 'Interior Design & Execution',
  initial: 'P',
  stars: 5,
  text: 'Architecture starts when you carefully put two bricks together, and this team understands that principle perfectly. The difference between good and bad work is the time and care spent on the details. They were meticulous, structured, and highly professional throughout the entire project. They turned our vision into a beautifully executed reality.',
},
{
  name: 'aqsa lakdawala',
  ...
  initial: 'A',
  stars: 5,
  text: 'These guys designed my office, and I must say they’re highly professional, with exquisite ideas and amazing workmanship. Definitely recommend them to all. Especially Ryan—his ideas are exceptional, and he knows what he’s doing. Thank you so much.',
},
{
  name: 'Uraz Unani',
  location: 'Full Home Interior · Kalyani Nagar, Pune',
  initial: 'U',
  stars: 5,
  text: 'Had a great experience with 3 Bricks for the complete interior design and execution of my home in Kalyani Nagar, Pune. The team handled our full home interiors, including the living room, bedrooms, modular kitchen, wardrobes, lighting and overall space planning. What I particularly liked was their attention to detail and how the designs were customized according to our requirements rather than using a standard approach. The team was professional, responsive and helpful throughout the design and execution process. I would definitely recommend 3 Bricks to anyone looking for interior designers in Kalyani Nagar or Pune for full home interiors, renovation or turnkey interior design. Really happy with how our home turned out!',
},
{
  name: 'abdulmalik arifi',
  location: 'Interior Work',
  initial: 'A',
  stars: 5,
  text: 'They do very good work and are trustworthy. I have experienced it very closely. You should never think twice before giving the work to them; you can be tension-free once you hand over the interior work to them. Good work, guys. Keep it up!',
},
{
  name: 'Atul Gaikwad',
  location: '',
...
{
  name: 'Bhushan Gangurde',
  location: 'Interior Design',
  initial: 'B',
  stars: 5,
  text: '3 Bricks understood our requirements very well and transformed our ideas into a beautiful, practical, and elegant...',
},
{
  name: 'Sagar Gurram',
  location: '',
...
},
{
  ...
  initial: 'I',
  stars: 5,
  text: 'Had a great experience with the interior team! The entire process was smooth and well-coordinated, and special thanks to...',
},
{
  name: 'sohail khan',
  location: 'Interior Design',
  initial: 'S',
  stars: 5,
  text: 'I had a great experience with this interior design company. The team was professional, creative, and very attentive to...',
},
{
  name: 'Vijaykumar Km',
  location: '',
...
},
{
  ...
  initial: 'M',
  stars: 5,
  text: 'Absolutely professional team. They will help you in every way and get the work done as promised 💯',
},
{
  name: 'percy bidari',
  location: '',
...
{
  name: 'Priya Karda',
  location: 'Custom Sofa / Furniture',
  initial: 'P',
  stars: 5,
  text: 'They provide very good service. The prices are very reasonable, and the quality of the sofa is too good. We just showed them a sofa picture for reference, and they made it beautifully in reality. Thank you! ☺️',
},
{
  name: 'Wahid Sayed',
  location: '',
...
},
{
  ...
  initial: 'S',
  stars: 5,
  text: 'The company is very good. They listen to customers very carefully and complete the work according to the customer’s requirements within the given time limits. I would definitely recommend the company.',
},
{
  name: 'mehnoor shaikh',
  location: '',
...
},
{
  ...
  initial: 'R',
  stars: 5,
  text: 'More than expected. I was happy with the work and happy to give these guys the project.',
},
{
  name: 'Misbah Inamdar',
  location: '',
...
},
{
  ...
  initial: 'Y',
  stars: 5,
  text: 'Innovative ideas and design, economical qualitative work, and eye-catching interiors.',
},
{
  name: 'Tejas chandanshiv',
  location: 'Office Interior',
  initial: 'T',
  stars: 5,
  text: 'We are extremely happy with the work done for our office. The designer understood our requirements perfectly and...',
},
{
  name: 'mahmood alam',
  location: 'Interior Work',
  initial: 'M',
  stars: 5,
  text: 'Best quality for all interior work.',
},
{
  name: 'Anwar Tajmat',
  location: '',
...
},
{
  ...
  initial: 'A',
  stars: 5,
  text: 'It was a very smooth and stress-free experience. They recently completed our home interiors and did an incredible job...',
},
{
  name: 'Harsh Bhapkar',
  location: '',
...
{
  name: 'Junaid Khimjibhai',
  location: '',
  initial: 'J',
  stars: 5,
  text: 'Amazing experience, would recommend to all.',
},
{
  name: 'Shweta Chary',
  location: 'Home Interior',
  initial: 'S',
  stars: 5,
  text: 'Detailed description of what is best for your home. Very calm and composed, with detailing at its peak. Does not hurry and values your...',
},
{
  name: 'Alam Shaikh',
  location: 'Interior Work',
  initial: 'A',
  stars: 5,
  text: 'If you want anyone to do your work with precision and perfection, Ryan bhai and Akash bhai are the ones who know what you want. They deliver exactly what you want and how you want it, without any complaints.',
},
{
  name: 'rockstar faizy',
  location: '',
...
},
{
  ...
  initial: 'A',
  stars: 5,
  text: 'Amazing work and excellent service within the prescribed time.',
},
{
  name: 'Mehul Oswal',
  location: '',
...
},
{
  ...
  initial: 'S',
  stars: 5,
  text: 'Really happy with the interior work they did for our home! The team was professional, creative, and completed everything beautifully.',
},
{
  name: 'mujahid mulani',
  location: '',
...
},
{
  ...
  initial: 'A',
  stars: 5,
  text: 'Mr. Sufiyan has done a wonderful job designing and executing our office interiors from scratch to completion. The final...',
}
]
